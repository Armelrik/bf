...
function AboutUs() {
  return (
    <div className='about-container'>
        ...
        <p>Depuis son indépendance en août 1960, le Burkina Faso a connu plusieurs régimes politiques : État de droit et État d'exception. À partir de 1991, le pays a officiellement opté pour un système politique démocratique en adoptant une constitution par voie référendaire et en organisant des élections présidentielles et législatives.
...
et la Commission Nationale de la Décentralisation (CND).</p>
    </div>
  )
}
